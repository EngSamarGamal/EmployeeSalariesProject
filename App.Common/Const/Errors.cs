...
namespace App.Common.Const
{
    public static class Errors
    {
        ...
        public const string OnlyItalyLetters = "Only Italy letters are allowed.";
        public const string OnlyNumbersAndLetters = "Only Italy/English letters or digits are allowed.";
